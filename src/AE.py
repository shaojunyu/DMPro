...
parser.add_argument("--model", type=str, default="",
                    help="model file to load or save")
parser.add_argument("--data_prefix", type=str, default="tmp/processed/",
                    required=False, help="data path prefix")
parser.add_argument("--platform", type=str, default="450k",
                    help="450k or EPIC, Illumina platform")
...
train_samples = pd.read_csv(
    "tmp/processed/train_samples.txt", header=None)[0].values
